...
Marlon Barrios Solano is an interdisciplinary artist, researcher, educator, and consultant, celebrated for his pioneering work at the nexus of art, technology, and cognition. Based in Berlin and currently engaged as  an artist-in-residence with the Rewilding Cultures program at Radiona in Zagreb, Croatia, and Lake Studios Berlin (Germany). Hiw work has been selected by the 'Black Box competition: No Middle Ground' to be exhibited at the Mikser Festival 2024 in Belgrade, Serbia. Marlon blends his expertise in software engineering with generative AI and dance improvisation, enhanced by a deep commitment to mindfulness practices.

Marlon is the creator and leader of the AI+ART+LAB, an online lab and studio dedicated to the exploration of deep learning, creativity, and cognition. This innovative platform focuses on the utilization of open-source models and the principles of decentralized AI to advance the field of creative technologies. AI+ART+LAB serves as a hub for collaboration and innovation, exploring the intersections of artificial intelligence, art, and cognitive science to push the boundaries of creative expression and technological application.

For over 15 years, Marlon has consulted, taught, and developed projects internationally, focusing on networked knowledge, embodied practices, and the evolving landscapes of Web 2.0 and Web 3.0 technologies. His prolific output includes over 200 video interviews with artists, makers, and philosophers, which have been published widely across various media. His insightful articles on Medium delve into the impacts of generative AI, particularly large language models (LLMs), on knowledge creation and social change.

Marlon’s unique synthesis of computational creativity and cognition with practices rooted in embodied cognition and mindfulness meditation guides his teaching, consulting, and software development from concept to deployment of AI-powered applications. His work not only demonstrates the practical applications of cutting-edge technology in the arts and mindfulness but also promotes a broader understanding of how these tools can catalyze social and cultural evolution. He has led workshops and provided consultancy internationally, reinforcing his role as a global influencer in the integration of technology with creative and mindful practices.

For more insights into his work and philosophy, visit Marlon's Portfolio and explore his thoughtful contributions on Medium.
