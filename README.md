...
The image with the circles  is augmented with a layer video as texture ona a 3D plane. Load this link on your smart phone scanning the QR code  then scan the image. You will see a plane with a video and sound  floating above the image.
